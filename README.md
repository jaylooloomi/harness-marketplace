...
[![Latest Release](https://img.shields.io/github/v/release/jaylooloomi/auto-review?label=release&color=blue)](https://github.com/jaylooloomi/auto-review/releases/latest)
...
```
/plugin marketplace add jaylooloomi/auto-review
```
